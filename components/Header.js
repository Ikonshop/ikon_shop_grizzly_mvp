...
export default function HeaderComponent() {
  ...
  const renderHeaderMenu = () => {
    return (
      <div className={styles.menuContainer}>
        <div
          onClick={() => (setShowMenu(false), setShowLoginOptions(false))}
  ...
  const renderLoginOptions = () => {
    return (
      <div className={styles.loginOptions_overlay}>
        <div className={styles.loginOptions}>
          ...
          <div className={styles.loginOption}>
            Browser Wallet:
            <WalletMultiButton className="disconnect-button" />
          </div>
          <div className={styles.loginOption}>
            <div className={styles.not_registered}>
              ...
              <Link href="/register">
                <a
                  onClick={() => (
                    setShowMenu(false), setShowLoginOptions(false)
                  )}
                >
